...
cancer_SVM=SVM()
cancer_SVM.fit(X_train,y_train,2)
#print(cancer_SVM._w)
...
#Salvo i dati per l'elaborazione in C++
np.savetxt("W.csv", cancer_SVM._w, delimiter=",")
np.savetxt("b.csv", np.array([cancer_SVM._b]), delimiter=",")
np.savetxt("X_test.csv", X_test, delimiter=" ")
np.savetxt("y_test.csv", y_test, delimiter=",")
np.savetxt("y_pred_py.csv", y_pred, delimiter=",")
np.savetxt("lambdas.csv", cancer_SVM._lambdas, delimiter=",")
np.savetxt("sv_y.csv", cancer_SVM._sv_y, delimiter=",")
np.savetxt("sv_x.csv", cancer_SVM._sv_x, delimiter=" ")
